...
{
    public class AmazaRegTest : Network
    {
        public AmazaRegTest()
        {
            this.Name = "AmazaRegTest";
            this.NetworkType = NetworkType.Regtest;
            this.Magic = BitConverter.ToUInt32(Encoding.ASCII.GetBytes("RAmZa"));
            ...
            Block genesisBlock = AmazaNetwork.CreateGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward, "regtestamazagenesisblock");
