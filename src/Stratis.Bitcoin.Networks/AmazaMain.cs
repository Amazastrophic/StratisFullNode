...
namespace Stratis.Bitcoin.Networks
{
    public class AmazaMain : Network
    {
        public AmazaMain()
        {
            ...
            this.Magic = BitConverter.ToUInt32(Encoding.ASCII.GetBytes("AmZa"));
            ...
            Block genesisBlock = AmazaNetwork.CreateGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward, "sagetowers.com/crypto/");
            ...
            //    new DNSSeedData("straxmainnet2.stratisnetwork.com", "straxmainnet2.stratisnetwork.com")
                ...
                new DNSSeedData(TestIPThree, TestIPFour)
            };
