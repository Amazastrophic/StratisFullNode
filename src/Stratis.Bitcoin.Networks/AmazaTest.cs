...
{
    public sealed class AmazaTest : Network
    {
        public AmazaTest()
        {
            string TestIPOne = "";
            ...
            this.Magic = BitConverter.ToUInt32(Encoding.ASCII.GetBytes("TAmZa"));
            ...
            Block genesisBlock = AmazaNetwork.CreateGenesisBlock(consensusFactory, this.GenesisTime, this.GenesisNonce, this.GenesisBits, this.GenesisVersion, this.GenesisReward, "testamazagenesisblock");
            ...
            var encoder = new Bech32Encoder("tamaza");
            ...
            this.DNSSeeds = new List<DNSSeedData>
            {
             ...
             new DNSSeedData(TestIPOne , TestIPTwo)
            };

            this.SeedNodes = new List<NetworkAddress>
            {
             //   new NetworkAddress(IPAddress.Parse("82.146.153.140"), 27105), // Iain
             new NetworkAddress(IPAddress.Parse(TestIPThree), 27105), // Iain
            };
